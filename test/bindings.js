  ...
  describe(`bindings-${bindingName}`, function() {
    ...
    describe('instance method', function() {
      describe('#open', function() {
        ...
        testFeature('baudrate.25000', 'supports a custom baudRate of 25000', function(done) {
        ...
        describe('optional locking', function() {
          ...
          testFeature('open.unlock', 'can unlock the port', function(done) {
      ...
      describe('#update', function() {
        ...
        testFeature('baudrate.25000', 'updates baudRate to a custom rate', function(done) {
      ...
      describe('#set', function() {
        ...
        testFeature('set.set', 'sets flags on the port', function(done) {
      ...
      describe('#get', function() {
        ...
        testFeature('get.get', 'gets modem line status from the port', function(done) {
